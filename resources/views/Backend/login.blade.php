                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" action="{{ route('admin_authenticate') }}" method="post">
                                    @csrf
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Forgot Your Password? <a href="pages-register.html">Reset password.</a></p>
                                    </div>
                                </form>

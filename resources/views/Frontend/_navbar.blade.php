<nav>
    <div class="container">
        <div class="nav-inner">
            <div class="logo-small"> <a class="logo" title="Magento Commerce" href="index.html"><img alt="Magento Commerce" src="{{asset('assets/frontend')}}/images/logo.png"></a> </div>
            <!-- mobile-menu -->
                                ...
                                <ul class="topnav">
                                    <li class="level0 nav-6 level-top first parent"> <a class="level-top" href="#"> <span>Pages</span> </a>
                                        <ul class="level0">
                                            ...
                                            <li class="level1 nav-10-3"> <a href="http://ow.ly/XqzNo"> <span>Product Detail</span> </a> </li>
